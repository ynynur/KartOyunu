...
/*        for(Integer i =1;i<=itemSayisi;i++){
    ...
    //Constructor !
    public Form(ArrayList<Sporcu> kullanici) { // kullanıcı elindeki kartları ekranda gösteriyorum
